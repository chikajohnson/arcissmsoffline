		...
		<div class="row text-left ">
			<div class="panel-body">
				...
				<div class="col-sm-12 text-right">
					<a href="<?php echo base_url(); ?>examiner/results" title="Back to results" class="btn btn-lg btn-default glyphicon glyphicon-arrow-left pull-left"></a>
			...
			<div class="col-sm-2 text-right">
				<a href="<?php echo base_url(); ?>examiner/results" title="Back to results" class="btn btn-lg btn-default glyphicon glyphicon-arrow-left"></a>
			</div>
			<?php endif; ?>			
		</div>
	</div>
