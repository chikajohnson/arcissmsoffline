...
class Notifications extends CI_Controller {
	...
	public function index($Starting=0)
	{
		...
		//var_dump($data); die();
		$data['main'] = "examiner/notifications/index";
	...
	public function delete($id=0)
	{
		if ($this->notification_model->check_if_id_exists($id) == NULL) {
			...
			redirect('examiner/notifications','refresh');
		}
	}
	...
	public function detail($id=0)
	{
		...
		if ($this->notification_model->check_if_id_exists($id) == NULL) {
			...
			$data['main'] = "examiner/notifications/detail";
			$this->load->view('examiner/layout/main', $data);
		}
	}
	...
	public function search()
	{
		if (!isset($_POST['notification'])){
			redirect('examiner/notifications/index','refresh');
		}
